      ...
      <div className="h-screen bg-sky-700 flex justify-center items-center">
        ...
        <div className="w-[400px] h-[550px] bg-blue-100 rounded-[15px] border border-slate-500 flex flex-col justify-center items-center space-y-20">
          <div className="space-y-6 flex flex-col justify-center items-center">
            <h1 className="text-center text-sky-700 text-3xl font-bold font-primary capitalize">Log In</h1>
            ...
            <button className="w-[225px] h-[45px] bg-sky-700 rounded-[10px] text-center text-white text-[25px] font-semibold font-['Inter'] capitalize">Sign In</button>
          </div>
          <p className="text-black text-md font-normal font-['Poppins']">
            Don't Have an Account?
            <Link to="/register" className="ms-1 text-sky-700 text-md font-semibold font-primary">
              Sign Up
            </Link>
          </p>
        </div>
